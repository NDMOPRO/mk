...
const translations = {
  ar: {
    ...
    "collections.saved": "العقارات المحفوظة",
    "collections.inspections": "المعاينات المخططة",
    "collections.enquired": "الاستفسارات",
    "collections.hidden": "المخفية",
    "collections.noSaved": "لا توجد عقارات محفوظة بعد",
    "collections.noInspections": "لا توجد معاينات مخططة",
    "collections.noEnquiries": "لا توجد استفسارات بعد",
    "collections.noHidden": "لا توجد عقارات مخفية",
    "collections.unhide": "إظهار",
    ...
    "auth.passwordTooShort": "كلمة المرور يجب أن تكون 7 أحرف على الأقل (حرف كبير + صغير + رقم + رمز خاص)",
    ...
    "adminMenu.opsHub": "مركز العمليات",
    ...
    "adminMenu.aiControl": "تحكم المساعد الذكي",
    "adminMenu.aiRatings": "تقييمات المساعد الذكي",
    "adminMenu.whatsapp": "واتساب",
    "adminMenu.integrations": "التكاملات",
    "adminMenu.shomoos": "شموس",
    "adminMenu.kyc": "التحقق من الهوية",
    "adminMenu.featureFlags": "مفاتيح الميزات",
    "adminMenu.hardening": "تقوية الإنتاج",
    "adminMenu.cms": "إدارة المحتوى",
    "adminMenu.auditLog": "سجل المراجعة",
    ...
    "adminMenu.sectionProperties": "العقارات",
    "adminMenu.sectionOperations": "العمليات",
    "adminMenu.sectionMarketing": "التسويق والمحتوى",
    "adminMenu.sectionAnalytics": "التحليلات",
    "adminMenu.sectionSystem": "النظام",
    // Settings metadata
    ...
    "verify.subtitle": "أكمل المعلومات التالية لإتمام الحجز",
    "verify.saudiNational": "مواطن سعودي",
    "verify.resident": "مقيم (غير سعودي)",
    "verify.visitor": "زائر / سائح",
    "verify.nationalId": "رقم الهوية الوطنية",
    "verify.nationalIdPlaceholder": "1xxxxxxxxx",
    "verify.residentNo": "رقم الإقامة",
    "verify.residentNoPlaceholder": "2xxxxxxxxx",
    "verify.passportNo": "رقم جواز السفر",
    "verify.passportNoPlaceholder": "A542817",
    "verify.dateOfBirth": "تاريخ الميلاد",
    "verify.nationality": "الجنسية",
    "verify.selectNationality": "اختر الجنسية",
    "verify.hijri": "هجري",
    "verify.gregorian": "ميلادي",
    "verify.verify": "تحقق",
    "verify.verified": "تم التحقق",
    "verify.verifying": "جاري التحقق...",
    "verify.ok": "موافق",
    "verify.cancel": "إلغاء",
    "verify.saved": "تم حفظ بيانات التحقق بنجاح",
    "verify.selectDate": "اختر التاريخ",
    "verify.day": "اليوم",
    "verify.month": "الشهر",
    "verify.year": "السنة",
  },
  en: {
    ...
    "collections.saved": "Saved properties",
    "collections.inspections": "Planned inspections",
    "collections.enquired": "Enquired",
    "collections.hidden": "Hidden",
    "collections.noSaved": "No saved properties yet",
    "collections.noInspections": "No planned inspections",
    "collections.noEnquiries": "No enquiries yet",
    "collections.noHidden": "No hidden properties",
    "collections.unhide": "Unhide",
    ...
    "auth.passwordTooShort": "Password must be at least 7 characters (uppercase + lowercase + digit + special character)",
    ...
    "adminMenu.opsHub": "Operations Hub",
    ...
    "adminMenu.aiControl": "AI Control Panel",
    "adminMenu.aiRatings": "AI Ratings",
    "adminMenu.whatsapp": "WhatsApp",
    "adminMenu.integrations": "Integrations",
    "adminMenu.shomoos": "Shomoos (شموس)",
    "adminMenu.kyc": "Identity Verification (KYC)",
    "adminMenu.featureFlags": "Feature Flags",
    "adminMenu.hardening": "Production Hardening",
    "adminMenu.cms": "CMS",
    "adminMenu.auditLog": "Audit Log",
    ...
    "adminMenu.sectionProperties": "Properties",
    "adminMenu.sectionOperations": "Operations",
    "adminMenu.sectionMarketing": "Marketing & Content",
    "adminMenu.sectionAnalytics": "Analytics",
    "adminMenu.sectionSystem": "System",
    // Settings metadata
    ...
    "verify.subtitle": "Complete the following information to complete reservation",
    "verify.saudiNational": "Saudi National",
    "verify.resident": "Resident (Non-Saudi)",
    "verify.visitor": "Visitor/Tourist",
    "verify.nationalId": "National ID Number",
    "verify.nationalIdPlaceholder": "1xxxxxxxxx",
    "verify.residentNo": "Resident No.",
    "verify.residentNoPlaceholder": "2xxxxxxxxx",
    "verify.passportNo": "Passport Number",
    "verify.passportNoPlaceholder": "A542817",
    "verify.dateOfBirth": "Date of birth",
    "verify.nationality": "Nationality",
    "verify.selectNationality": "Select nationality",
    "verify.hijri": "Hijri",
    "verify.gregorian": "Gregorian",
    "verify.verify": "Verify",
    "verify.verified": "Verified",
    "verify.verifying": "Verifying...",
    "verify.ok": "OK",
    "verify.cancel": "Cancel",
    "verify.saved": "Verification data saved successfully",
    "verify.selectDate": "Select date",
    "verify.day": "Day",
    "verify.month": "Month",
    "verify.year": "Year",
  },

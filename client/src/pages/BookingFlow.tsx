          ...
          <CardContent className="p-0">
            <div className="flex items-stretch">
              <div className="w-28 h-28 shrink-0 bg-muted">
                <img loading="lazy" src={normalizeImageUrl(prop.photos?.[0]) || BROKEN_IMAGE_PLACEHOLDER} alt="" className="w-full h-full object-cover" onError={(e) => { (e.currentTarget as HTMLImageElement).src = BROKEN_IMAGE_PLACEHOLDER; }} />
              </div>
